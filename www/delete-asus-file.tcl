# /packages/intranet-security-update-client/www/delete-asus-file.tcl
#
...
set service_base_url "https://www.project-open.net/intranet-asus-server/delete-asus-file.xml"
